...
|-------------------|----------------------------|-----------------------------|
| **Expected Time** | 5 minutes                  | 0.8 seconds per package     |
...
├── download_word2vec_model.sh        # File to download word2vec_model
├── download_tranco_list.py           # File to download domain rank file
├── download_nltk_model.py            # File to nltk related configuration
├── Dockerfile                        # File to setup docker environment
